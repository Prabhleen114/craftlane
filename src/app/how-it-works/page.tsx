                      ...
                      {step.bullets && (
                        <ul className="list-disc pl-5 mt-3 space-y-2 text-sm text-brand-charcoal/60 leading-relaxed">
                          {step.bullets.map((bullet, bIdx) => (
                            <li key={bIdx}>
                              {bullet.includes("30% payment") ? (
                                <>
                                  Receive <strong className="text-brand-charcoal">30% payment</strong> after you share the shipment proof.
                                </>
                              ) : bullet.includes("70%") ? (
                                <>
                                  Get the remaining <strong className="text-brand-charcoal">70%</strong> once the customer receives the order.
                                </>
                              ) : (
                                bullet
                              )}
