      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block mb-4 text-2xl font-bold tracking-tight text-brand-charcoal font-serif">
              Ekora
            </Link>
            ...
            <div className="flex items-center gap-4 text-sm font-medium text-brand-charcoal/50">
              <a href="#" className="hover:text-brand-charcoal transition-colors">Instagram</a>
              <a href="#" className="hover:text-brand-charcoal transition-colors">Twitter</a>
              <a href="#" className="hover:text-brand-charcoal transition-colors">LinkedIn</a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-brand-charcoal/60 font-medium">
              ...
              <li><Link href="#" className="hover:text-brand-charcoal transition-colors">Careers</Link></li>
              <li><Link href="#" className="hover:text-brand-charcoal transition-colors">Press</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-brand-charcoal/60 font-medium">
              <li><Link href="#" className="hover:text-brand-charcoal transition-colors">Terms of Service</Link></li>
              <li><Link href="#" className="hover:text-brand-charcoal transition-colors">Privacy Policy</Link></li>
              <li><Link href="#" className="hover:text-brand-charcoal transition-colors">Refund Policy</Link></li>
              <li><Link href="#" className="hover:text-brand-charcoal transition-colors">Creator Guidelines</Link></li>
            </ul>
          </div>
        </div>
