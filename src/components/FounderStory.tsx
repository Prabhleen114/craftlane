        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-6 flex items-start gap-4">
              <div className="w-20 h-20 rounded-full bg-zinc-100 border-2 border-zinc-200 flex flex-col items-center justify-center flex-shrink-0 text-center">
                 <User className="w-6 h-6 text-zinc-400 mb-1" />
                 <span className="text-[8px] uppercase tracking-wider text-zinc-500 font-semibold leading-tight">Photo<br/>Coming<br/>Soon</span>
              </div>
              <div>
