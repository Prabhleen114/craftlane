        ...
        <div className="flex flex-col gap-3 mt-4 h-[250px] overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <div className="bg-white rounded-lg border border-zinc-200 p-2 shadow-sm">
              ...
              <h4 className="text-xs font-semibold text-zinc-900 truncate">Speckled Mug</h4>
              <div className="text-[10px] text-zinc-500 mt-1">₹890</div>
            </div>
            <div className="bg-white rounded-lg border border-zinc-200 p-2 shadow-sm">
              <div className="relative aspect-square rounded bg-zinc-100 mb-2 overflow-hidden">
                <Image src="/images/home_decor.png" alt="Decor" fill className="object-cover" />
              </div>
              <h4 className="text-xs font-semibold text-zinc-900 truncate">Wood Clock</h4>
        ...
        <div className="flex flex-col gap-3 mt-4 h-[250px] overflow-hidden">
          ...
          <div className="px-4 mt-5">
            <div className="flex items-center gap-1.5">
              <h4 className="font-semibold text-zinc-900 text-sm">Anika&apos;s Art</h4>
              <ShieldCheck className="w-3.5 h-3.5 text-green-500" />
            </div>
            <p className="text-[10px] text-zinc-500 mt-0.5">Handcrafted resin and floral art.</p>
          </div>
          <div className="px-4 mt-2">
            <div className="bg-white rounded-lg border border-zinc-200 p-2 shadow-sm flex gap-3 items-center">
              <div className="relative w-12 h-12 rounded bg-zinc-100 overflow-hidden flex-shrink-0">
                 <Image src="/images/resin_art.png" alt="Resin" fill className="object-cover" />
              </div>
              <div className="flex-1">
                <h4 className="text-xs font-semibold text-zinc-900">Resin Coaster</h4>
                <div className="text-[10px] text-zinc-500">₹450</div>
              </div>
        ...
        <div className="flex flex-col gap-2 mt-4 h-[250px] overflow-hidden bg-zinc-50/50 p-2 rounded-xl border border-zinc-100">
          <div className="bg-white rounded-lg border border-zinc-200 p-3 shadow-sm flex justify-between items-center">
             <div className="flex gap-3 items-center">
               ...
               <div>
                 <h4 className="text-xs font-semibold text-zinc-900">Vanilla Candle</h4>
                 <div className="text-[10px] text-zinc-500">from The Candle Co.</div>
               </div>
             </div>
             <div className="text-xs font-bold text-zinc-900">₹450</div>
          </div>
          
          <div className="bg-white rounded-lg border border-zinc-200 p-3 shadow-sm flex justify-between items-center">
             <div className="flex gap-3 items-center">
               <div className="relative w-10 h-10 rounded bg-zinc-100 overflow-hidden">
                 <Image src="/images/jewelry.png" alt="Jewelry" fill className="object-cover" />
               </div>
               <div>
                 <h4 className="text-xs font-semibold text-zinc-900">Gold Necklace</h4>
                 <div className="text-[10px] text-zinc-500">from Aura Gems</div>
               </div>
             </div>
             <div className="text-xs font-bold text-zinc-900">₹1,850</div>
          </div>

          <div className="mt-auto">
            <div className="flex justify-between items-center px-1 mb-2">
              <span className="text-xs font-medium text-zinc-500">Total</span>
              <span className="text-sm font-bold text-zinc-900">₹2,300</span>
            </div>
        ...
        <div className="flex flex-col gap-3 mt-4 h-[250px] overflow-hidden">
          <div className="grid grid-cols-2 gap-3">
             <div className="bg-white rounded-lg border border-zinc-200 p-3 shadow-sm">
                 ...
                 <div className="text-lg font-bold text-zinc-900 mb-1">₹42.5K</div>
                 <div className="text-[10px] font-semibold text-green-600">+12% this week</div>
             </div>
             <div className="bg-white rounded-lg border border-zinc-200 p-3 shadow-sm">
                 <div className="flex items-center gap-1.5 mb-2 text-zinc-500">
                 ...
                 <div className="text-lg font-bold text-zinc-900 mb-1">128</div>
                 <div className="text-[10px] font-semibold text-green-600">+8% this week</div>
             </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-zinc-200 p-4 shadow-sm flex-1 flex flex-col justify-end relative overflow-hidden">
            <div className="absolute top-3 left-3 flex items-center gap-1.5 text-zinc-500">
              ...
              <span className="text-[10px] font-medium uppercase tracking-wider">Store Views</span>
            </div>
            {/* Fake Chart bars */}
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-zinc-500 max-w-2xl mx-auto">
            We are building the complete commerce infrastructure for independent creators. Here is a sneak peek at the experience.
          </p>
        </div>
